    ...
    <div className="flex flex-col items-center min-h-[calc(100vh-748px)]">
      <div className="max-w-[1920px] w-full px-[264px] max-2xl:px-[160px] max-lg:px-[90px] max-tiny:px-[25px] pb-[100px] flex flex-col gap-y-[50px] relative">
        ...
        <div className="grid grid-cols-2 max-lg:grid-cols-1 gap-[20px]">
          <div className="flex flex-col gap-y-[10px] h-[558px] max-lg:h-[538px] max-tiny:h-[329px]">
            <div className="relative w-full h-[calc(100%-110px)] max-lg:h-[calc(100%-105px)] max-tiny:h-[calc(100%-61px)] rounded-[12px] max-tiny:rounded-[3px] overflow-hidden">
              <Image
            ...
            <div className="grid grid-cols-5 gap-[10px] h-[100px] max-lg:h-[95px] max-tiny:h-[61px]">
          ...
          <div className="w-full h-full max-lg:aspect-[5/3] rounded-[12px] max-tiny:rounded-[4px] overflow-hidden">
            <iframe
        ...
        <div className="grid grid-cols-2 max-lg:grid-cols-1 gap-[20px]">
          ...
          <div className="flex flex-col gap-y-[10px] h-[558px] max-lg:h-[538px] max-tiny:h-[329px] max-lg:order-first">
            <div className="relative w-full h-[calc(100%-110px)] max-lg:h-[calc(100%-105px)] max-tiny:h-[calc(100%-61px)] rounded-[12px] max-tiny:rounded-[3px] overflow-hidden">
              <Image
                src="/images/shopimg.png"
                alt={""}
