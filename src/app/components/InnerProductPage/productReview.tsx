        ...
        <div className="grid grid-cols-2 max-lg:grid-cols-1 gap-[20px] max-lg:gap-[10px]">
          {loaderProdReview
            ? [1, 2, 3, 4].map((index: any) => (
                <div
                  key={index}
                  className="w-full h-[150px] rounded-[12px] overflow-hidden"
                >
                  ...
                  <div className="flex items-center justify-between">
                    {item.user_id !== null ? (
                      <div className="flex items-center gap-[10px]">
                        <div className="w-[50px] h-[50px] flex items-center justify-center text-[17px] relative rounded-full overflow-hidden">
                          {item?.user?.img ? (
                            <Image
                              src="/images/food.png"
                              alt={""}
