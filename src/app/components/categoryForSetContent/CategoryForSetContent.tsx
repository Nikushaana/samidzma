...
// import PathRouterCategoryForSetContent from "./PathRouterCategoryForSetContent";

// export const CategoryForSetContent = ({
//   childCategsloader,
//   childCategsData,
// }: any) => {
...
//     if (pathname.split("/")[1] === "category-for-set") {
...
//     axiosUser
//       .get(
//         `front/ourProduct?pageNumber=${currentPage + 1}&itemsOnPage=12&nakrebi=1&${
...
//           "/category-for-set",
//           `${pathname}/${
//             slugify(res.data.ProdTypeGroupName) + "_" + res.data.IdProdSaxeoba
//           }/${id}?${filterValues.key ? `key=${filterValues.key}` : ""}`
//         );
//       })
//       .catch((err) => {})
//       .finally(() => {});
...
//               <EverySlider
//                 data={firstCategsData}
//                 loader={firstCategsLoader}
...
//           <PathRouterCategoryForSetContent />
...
//                     >
//                       {pathnameItems.length <= 1
//                         ? item.ProdTypeGroup || item.ProdTypeGroupName
