...
import { BsCart3, BsChatDots, BsGift, BsNewspaper } from "react-icons/bs";
import { AiOutlineBranches, AiOutlineStock } from "react-icons/ai";
...
export default function SideBar() {
  ...
  const [route, setRoute] = useState([
    ...
    {
      id: 7,
      route: "სამიძმის ფილიალები",
      link: "samidzma-branches",
      links: [
        {
          id: 1,
          route: "სამიძმის ფილიალების დამატება",
          link: "add-samidzma-branches",
        },
        {
          id: 2,
          route: "ფილიალების ფოტოები",
          link: "branches-images",
        },
      ],
    ...
    {
      id: 10,
      route: "პროდუქტების განახლება",
      link: "products-update",
      links: [
        {
          id: 1,
          route: "განახლების დაგეგმვა",
          link: "add-cron-jobs",
        },
        {
          id: 2,
          route: "პროდუქტის მინიმალური რაოდენობა",
          link: "product-min-quantity",
        },
      ],
      icon: <LuRefreshCw />,
    },
    ...
    {
      id: 17,
      route: "საიტის ინფორმაცია",
      link: "site-info",
      links: [
        {
          id: 1,
          route: "საიტის ინფორმაციის დამატება",
          link: "add-site-info",
        },
      ],
      icon: <FaInfo />,
          ...
          {route.map((item, index: number) => (
            <div key={item.id}>
              <div
                ...
                className="flex items-center gap-[5px] h-[40px] w-full group cursor-pointer"
              >
                <div
                ...
                >
                  <div className={`flex items-center gap-[15px] duration-150 `}>
                    <div
                      className={`relative flex items-center justify-center text-[22px] ${
                    ...
                    <h1
                      ...
                      className={`duration-150 text-[12px] ${
                        userMenu ? "" : "hidden"
                      } ${
                        acturl.first === item.link
                          ? "text-myGreen"
                          : "hover:text-myGreen active:text-myGreen"
                      }`}
                    >
                      {item.route}
                    </h1>
                  ...
                  {item.links.length > 0 && userMenu && (
                    <div
                      className={`relative duration-150 select-none flex items-center text-[13px] justify-center ${
                        dropedUrl === item.link
                          ? "text-myGreen"
