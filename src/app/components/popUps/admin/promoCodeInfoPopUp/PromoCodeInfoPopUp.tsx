    ...
    >
      <div
        ...
        className={`bg-[#0000003b] w-full h-full absolute z-[-1] duration-100 ${
          openPromoCodeInfoPopUp ? "backdrop-blur-[2px] " : "backdrop-blur-none"
        }`}
      ></div>
      <div
        className={`max-w-[1920px] max-lg:w-[90%] bg-[#EAEDEE] p-[16px] grid grid-cols-1 gap-[20px] rounded-[12px] max-h-[95vh] overflow-scroll showScrollVert showScrollHor relative`}
      >
        <div
          onClick={() => {
            setOpenPromoCodeInfoPopUp(null);
        ...
        <div className="min-w-[980px] mt-[30px]">
