    ...
    >
      ...
      >
        ...
        {actFirstCateg?.secCategData?.length > 0 ? (
          <div className="h-[calc(100%-102px)] max-sm:overflow-y-scroll showScrollVert">
            <div className="flex items-start gap-[20px] max-sm:flex-col max-sm:gap-0">
              <h1 className="text-[28px] max-md:text-[24px]">კატეგორიები:</h1>
              <div
                ref={scrollRef}
                onMouseMove={handleDrag}
                className="overflow-x-auto notShowScrollHor max-sm:overflow-hidden mb-[5px]"
              >
                <div className="flex items-start max-sm:flex-wrap py-[5px] gap-[10px] ">
            ...
            <div className="rounded-[8px] border-t-[10px] border-myGreen w-full h-[calc(100%-51px)] overflow-y-scroll max-sm:overflow-auto max-sm:h-auto showScrollVert bg-white flex flex-col gap-y-[20px] p-[20px] pb-[30px]">
              <h1
                onClick={() => {
              ...
              {actFirstCateg?.secCategData?.map((item1: any, index: number) => (
                ...
                >
                  ...
                  {item1.productTypes.length > 0 && (
                    <div className="grid grid-cols-10 max-xl:grid-cols-6 max-md:grid-cols-4 max-sm:grid-cols-2 gap-[10px]">
