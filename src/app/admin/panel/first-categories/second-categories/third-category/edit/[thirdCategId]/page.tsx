...
export default function Page({ params }: { params: { thirdCategId: string } }) {
  ...
  const [oneThirdCategRender, setOneThirdCategRender] = useState<any>();
  ...
  useEffect(() => {
    ...
    axiosAdmin
      ...
      .catch((err) => {})
      .finally(() => {});
  }, [params.thirdCategId, oneThirdCategRender]);
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-[20px] w-full">
        ...
        <Input1
          ...
          name="meta_title"
          type="text"
          firstValue={oneThirdCategValues.meta_title}
          setAllValues={setEditThirdCategValues}
          error={false}
        />
        <Input1
          ...
          type="text"
          firstValue={oneThirdCategValues.meta_description}
          setAllValues={setEditThirdCategValues}
          error={false}
        />
